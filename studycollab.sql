...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2025 at 05:50 AM
...
INSERT INTO `assessments` (`id`, `user_id`, `type`, `title`, `course`, `due_date`, `notes`, `created_at`, `status`) VALUES
(1, 7, 'Exam', 'MIS Exam', 'Management Information System', '2025-12-10 08:25:00', '', '2025-11-15 01:25:32', 'Pending');
...
INSERT INTO `classes` (`id`, `user_id`, `title`, `course`, `location`, `day`, `start_time`, `end_time`, `created_at`) VALUES
(1, 6, 'Web Programming', 'Cs123', 'Chipata', 'Wednesday', '07:53:00', '05:56:00', '2025-11-16 03:53:16');
...
(9, 'group6', 6, '2025-11-15 15:52:50'),
(10, 'group6', 6, '2025-11-15 15:57:14'),
(11, 'group6', 6, '2025-11-16 06:45:17'),
(12, 'group6', 6, '2025-11-16 06:49:36');
...
(8, 'group6', 6, 9, 6, 'Leader', '2025-11-15 15:52:50'),
(9, 'group6', 6, 10, 6, 'Leader', '2025-11-15 15:57:14'),
(10, 'group6', 6, 11, 6, 'Leader', '2025-11-16 06:45:17'),
(11, 'group6', 6, 12, 6, 'Leader', '2025-11-16 06:49:36');
...
(29, 'group6', 6, 11, 'English Presentation', 'Present a poem analysis', '2025-11-12', 'Pending', '2025-11-16 06:45:17', '2025-11-16 06:45:17'),
(30, 'group6', 6, 12, 'Programming Lab', 'Build a small web app', '2025-11-11', 'Pending', '2025-11-16 06:49:36', '2025-11-16 06:49:36');
...
(4, 6, 'Cs123', NULL, 'Programmming Fundementals', '<p>Add <code>session_start();</code> at the top.</p><p>Ensure <code>$conn</code> is defined (<code>require \'../includes/db.php\';</code>).</p><p><u>Check all SQL queries </u>for correct table/column names.</p><p>Use defensive coding when fetching query results.</p><p><strong>Clear browser cache to see changes.</strong></p>', 0, '2025-11-16 05:21:43');
...
(2, 6, 'Css123', 9, 'Intranet_and_extranet_assignment', '', '/studyCollab/uploads/resources/Intranet_and_extranet_assignment_1763263356_ff7598ea47a6.docx', '2025-11-16 05:22:36');
...
(18, 6, 'hello', 'coding', '2025-11-12', 'Pending', '2025-11-16 04:13:55', '2025-11-16 04:17:06');
...
(6, 'Diran Sai', 'dirantechie@gmail.com', '$2y$10$av12wNgsuOiQfL1FJcDizeEAOgnBcKlCz./b.bGZXcKS5YWM.4cTa', 'student', NULL, '2025-11-11 12:03:06', '2025-11-16 03:48:08', 'default-avatar.jpg', NULL, NULL, NULL, NULL),
